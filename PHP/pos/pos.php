...
<br><br><br>
 <center><img src="img/topPOS.jpg"><hr> 
<br><br>
<p class="text-center">
    <button class="btn btn-lg btn-success" data-toggle="modal" data-target="#loginModal">&nbsp;Login&nbsp;</button>&nbsp;&nbsp;&nbsp;&nbsp;
	<a href="../../../?category=Vitamins" class="btn btn-lg btn-success">Cancel</a>
</p>
...
if ($_REQUEST['wrong']=="yes")
{ echo "<center><br><br><hr> <img src=\"img/wrong.jpg\"> "; }		
?>
