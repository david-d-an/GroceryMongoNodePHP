<head>
<link href="css/style_php_pagination.css" rel="stylesheet" type="text/css" />
</head>
...
// echo stripcslashes($_REQUEST["string"])
...
$query = "SELECT COUNT(*) as num FROM $tableName $where";
	...
	$total_pages = ceil(count($yummy) / $pagesize);

// echo "Paginas: ".ceil($total_pages/$limit);
    ...
    // Get page data
	$query1 = "SELECT * FROM $tableName $where LIMIT $start, $limit";
